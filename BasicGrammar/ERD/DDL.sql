...
CREATE TABLE IF NOT EXISTS `mydb`.`PROFESSOR` (
  `PROFESSOR_CODE` VARCHAR(5) NOT NULL,
  `ID` VARCHAR(15) CHARACTER SET 'utf8' NOT NULL,
  `SALARY` INT NOT NULL,
  `ENT_DATE` NCHAR(8) NOT NULL COMMENT '입사일',
  `RET_DATE` NCHAR(8) NOT NULL COMMENT '퇴사일',
...
CREATE TABLE IF NOT EXISTS `mydb`.`STUDENT` (
  ...
  `RET_DATE` NCHAR(8) NOT NULL COMMENT '졸업일',
...
CREATE TABLE IF NOT EXISTS `mydb`.`MAJOR` (
  ...
  `PROFESSOR_HEAD_USER_CODE` VARCHAR(5) NOT NULL COMMENT '학과_지도교수',
...
CREATE TABLE IF NOT EXISTS `mydb`.`MINOR` (
  ...
  `MAJOR_CODE` NCHAR(2) NOT NULL COMMENT '학과_코드',
  `PROFESSOR_USER_CODE` VARCHAR(5) NOT NULL COMMENT '과목_지도교수',
...
CREATE TABLE IF NOT EXISTS `mydb`.`STUDENT_GRADE` (
  ...
  PRIMARY KEY (`GRANDE`, `STUDENT_CODE`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`STUDENT_SEMESTER` (
  ...
  CONSTRAINT `fk_STUDENT_SEMESTER_STUDENT_GRADE1`
    ...
    REFERENCES `mydb`.`STUDENT_GRADE` (`GRANDE` , `STUDENT_CODE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
